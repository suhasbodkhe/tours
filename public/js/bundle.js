        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.displayAlert)('success', 'Login is successful');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.displayAlert)('error', 'Error logging out. Try again.');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.displayAlert)('success', "".concat(type.toUpperCase(), " updated successfully"));
            }
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            console.log('password error: ', _context.t0);
            (0, _alert.displayAlert)('error', _context.t0.response.data.message);
...
var stripe = Stripe('pk_test_51IhvR8SEoaA1yHKrlu3kKyBr4RBmjqrkpoOl398umH8CWTapLBjAKoeEnSHgGQ5q95Q8tq0RapCW6UKrInjtK56m00yRaIjj6R');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alert.displayAlert)('error', _context.t0);
